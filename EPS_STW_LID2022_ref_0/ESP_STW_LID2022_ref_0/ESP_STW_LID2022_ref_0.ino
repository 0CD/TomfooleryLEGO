...
char buf[40];                                                           //  Serial2 bus buffer   


 
void setup()
{
                                                                          // Serial2 port for transfer data with Mega
  Serial.begin(9600);
...
//                      Serial.println(p->name());
                        ...
                        if ((p->name())=="track"){ Serial.println("Track"); };
                        if ((p->name())=="mazeDrive"){ Serial.println("MazeDrive"); };
                        if ((p->name())=="mazeStop"){ Serial.println("MazeStop"); };
